...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  final load = Loading();
  final userEmail = UserNow.usernow.user?.email;
                    ...
                    MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        if (isError) {
                          ...
                          final cred = EmailAuthProvider.credential(email: "$userEmail", password: passC.text);

                          user?.reauthenticateWithCredential(cred).then((value) async {
                            await user.updatePassword(newpassC.text).then((_) {
